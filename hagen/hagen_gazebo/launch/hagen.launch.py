...
def generate_launch_description():
  ...
  spawn_x_val = LaunchConfiguration('spawn_x_val',default='0.0')
  spawn_y_val = LaunchConfiguration('spawn_y_val',default='0.0')
  spawn_z_val = '0.0'
  spawn_yaw_val = LaunchConfiguration('spawn_yaw_val',default='0.0')
